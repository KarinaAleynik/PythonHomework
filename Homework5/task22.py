...
welcome_text = ('Правила игры:\n'
                'На столе лежит 2021 конфету, вы берете их поочереди,\n'
...
def player_vs_bot():
    ...
    while candies_total > 0:
        ...
        if players[lucky % 2] == 'Компьютер':
            print(
                f'\nХодит {players[lucky%2]} \nНа кону {candies_total} Сколько возьмешь?')
            ...
            step = int(input(
                f'\nХоди,  {players[lucky%2]} \nНа кону {candies_total} Сколько хочешь взять? '))
